...
def balanceo( cliente ):
    resp = { "opcion": "balanceo"}
    data = json.dumps( resp )
    cliente.send_json( data )
    while True:
    ...
    while True:
        ...
        if opciones.get( "opcion" ) == "ubicame!":
            ...
            if pertenece:
                ...
                infoSucesor = { "sucesor": sucesor, "opcion": "noTeUbique"}
            ...
            if rango.member( hashMb ):
                ...
                infoSucesor = { "sucesor": sucesor, "opcion": "noEsMio"}
        ...
        elif opciones.get( "opcion" ) == "balanceo":
            files = os.listdir( '.' )
            for items in files:
                if items != 'server2.py' and not rango.member( int( items ) ):
